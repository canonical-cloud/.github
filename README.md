# canonical-cloud organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`canonical-cloud`](https://github.com/canonical-cloud).

## Canonical organization links

- GitHub organization: https://github.com/canonical-cloud
- Public organization defaults: https://github.com/canonical-cloud/.github
...
`canonical-cloud` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
