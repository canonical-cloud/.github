...
For synchronization, avoid git rebase in favor of git merge so shared history remains additive and reviewable.
...
3. Review linked pull requests, issues, Linear work, related repositories in `canonical-cloud`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
