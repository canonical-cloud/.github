...
Planning and delivery context is tracked in [github.com/canonical-cloud](https://linear.app/denman/project/githubcomcanonical-cloud-1659c8ea1adf). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/canonical-cloud/.github).
